...
const CATALOGO = {
  es: {
    ...
    transaccion: { titulo: 'Aviso de pago (mis inmuebles)', cuerpo: (d) => `${d.propiedad}: ${d.importe} €${d.huesped ? ` · ${d.huesped}` : ''}` },
  ...
  en: {
    ...
    transaccion: { titulo: 'Payment notice (my properties)', cuerpo: (d) => `${d.propiedad}: ${d.importe} €${d.huesped ? ` · ${d.huesped}` : ''}` },
