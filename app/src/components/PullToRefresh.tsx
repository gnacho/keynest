...
/**
 * Pull-to-refresh móvil: al tirar hacia abajo desde el top de la página, recarga
 * (permite coger un deploy nuevo sin cerrar y reabrir la app). Solo actúa cuando
 * window.scrollY <= 0 y el gesto es un pull vertical.
 */
